...
class Monkey:
    def __init__(self, items: list[int], operation: Callable, testing: Callable, target_true, target_false, divider):
        self._items = items
...
def parse_monkey(fp: BinaryIO):
    ...
    test_fn, divider = create_test_function(fp.readline().decode())
